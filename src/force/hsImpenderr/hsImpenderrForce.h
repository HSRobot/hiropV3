...
public:
     ...
     * @return
     */
    virtual int setDirection(int *direction);

    /***
     *
     * @param _Stiffness 机器人刚度系数
     * @param _Damping   机器人阻尼系数
     * @param _Mass      机器人质量系数
     * @return
     */
    virtual int setParameters(double* _Stiffness,double* _Damping,double* _Mass);
