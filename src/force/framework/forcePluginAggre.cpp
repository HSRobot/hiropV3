...
int forcePluginAggre::setDirection(int *direction) {
    return forcePtr->setDirection(direction);
}

int forcePluginAggre::setParameters(double *_Stiffness, double *_Damping, double *_Mass) {
    return forcePtr->setParameters(_Stiffness,_Damping,_Mass);
}
